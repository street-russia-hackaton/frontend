...
import KseniaZamerova from '../assets/images/KseniaZamerova.svg';
import IlyaBezgulov from '../assets/images/IlyaBezgulov.svg';
import AlexandrGrigorev from '../assets/images/AlexandrGrigorev.svg';
import RosTeensIcon from '../assets/images/RosTeensIcon.svg';
import PresidentGrandFond from '../assets/images/PresidentGrandFond.svg';
...
export const InterviewAboutData = [
    {
        id: 0,
        image: CuratorImg,
        tag: 'Street art',
...
export const centralDepartmentsPersons = [
    {
        id: 0,
        link: '#',
        name: 'Валентин Работенко',
    ...
    },
    {
        ...
        position: 'Заместитель Председателя по GR политике и административному управлению ОООУКС «Улицы России»',
        imageSrc: CuratorImgVyacheslav,
    },
    {
        id: 2,
        ...
        text: <>Председатель Общероссийской общественной организации уличной культуры и спорта «Улицы России», генеральный директор международной конкурс-премии «КАРДО», директор общественной организации «ОФФБИТС», член экспертного совета Комитета Государственной Думы Российской Федерации по молодежной политике, советник ректора Северо-Кавказского федерального университета по общественным проекта, эксперт Государственного Совета Российской Федерации по направлению «Молодёжная политика».</>,
        position: 'Заместитель Председателя по образовательной политике',
        imageSrc: KseniaZamerova,
    },
];

export const regionalDepartmentsPersons = [
    {
        id: 0,
        link: '#',
        name: 'Анастасия Янченко',
    ...
    },
    {
        ...
        text: (
            <>
                Член правления ТРМОО СРС и СИ «Экспресс-Арт» ;
                <br />
                Руководитель многофункционального спортивного зала «Мастера Стилей»
            </>
        ),
        position: 'Тульская область',
        imageSrc: IlyaBezgulov,
    },
    {
        id: 2,
        link: '#',
        name: 'Александр Григорьев',
        text: <>Председатель Регионального отделения ОООУКС «Улицы России» в Томской области.</>,
        position: 'Томская область',
        imageSrc: AlexandrGrigorev,
    },
];
...
export const AboutPartnerData = [
    ...
    {
        id: 1,
        image: PresidentGrandFond,
        title: 'Фонд президентских грантов',
        text: ' Фонд президентских грантов является единым оператором государственной поддержки некоммерческих неправительственных организаций в Российской Федерации с 3 апреля 2017 года. Фонд на конкурсной основе выделяет гранты Президента Российской Федерации на реализацию социально значимых проектов некоммерческих неправительственных организаций и способствует развитию сектора таких организаций, благотворительности, добровольчества, в том числе через софинансирование поддержки общественных инициатив, оказываемой органами исполнительной власти субъектов Российской Федерации (региональными операторами). Миссия фонда — создание условий и возможностей для самореализации инициативных и неравнодушных людей в некоммерческом секторе.',
    },
    {
        id: 2,
        image: PresidentGrandFond,
...
export const AboutDocumentsData = [
    {
        id: 0,
        title: 'Свидетельство о государственной регистрации (ОГРН) юридического лица',
        date: '01.11.2021',
    },
    {
        id: 1,
