...
export const AboutUsData = [
    ...
    { id: 'target', title: 'Цели', text: 'Комплексное развитие уличной культуры и спорта. Популяризация уличных дисциплин.Создание положительного образа в информационном пространстве у дисциплин, которые считаются травмоопасными и агрессивными.' },
];

export const CardAboutUsSize = {
    mission: { width: '426px', height: '300px', top: '592px', left: '172px', zIndex: 2 },
    idea: { width: '426px', height: '339px', top: '340px', left: '507px', zIndex: 4 },
    target: { width: '427px', height: '382px', top: '663px', left: '730px', zIndex: 3 },
};
