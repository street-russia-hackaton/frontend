    ...
    return (
        <>
            ...
            <Box sx={{ display: 'flex', flexDirection: 'column', gap: '60px', p: { sm: '0' }, m: '60px auto', width: '91%', maxWidth: { lg: '1320px' } }}>
                ...
                {!isUser && <Container component="section" sx={{ display: 'flex', flexDirection: 'column', p: { sm: '0' }, m: '0 auto 64px', width: '100%', maxWidth: { lg: '1320px' } }}>
                    <Box sx={{ display: 'flex', justifyContent: 'space-between', p: { sm: '0' }, m: '00' }}>
                    ...
                    {objectCardData.slice(1, 4).map((data) => (
