            ...
            <Box sx={{ display: 'flex', flexDirection: 'column', p: { sm: '0' }, m: '0 auto', width: '91%', maxWidth: { lg: '1320px' } }}>
                <Box sx={{ display: ' flex ', justifyContent: 'space-between' }}>
                    <Box sx={{ display: ' flex ', flexDirection: 'column' }}>
                        <Title title="титл" background="none" margin="0 0 12px 0" width="100%" height="100%" padding="0" color="#fff" />
                        <Box sx={{ display: 'flex', alignItems: 'center', gap: '20px', p: { sm: '0' }, m: '0 0 64px 0' }}>
                            <Typography sx={{ ...styles.text, ...styles.small, ...styles.tag }}>таг</Typography>
                    ...
                    <Box>
                        <SubmitBtnWithIcon icon={<HeartIcon />} title="В избранное" width="190px"></SubmitBtnWithIcon>
                        <SubmitBtn title="Зарегистрироваться" width="240px" margin="0 0 0 17px"></SubmitBtn>
                    </Box>
                </Box>
                <CardMedia component="img" alt="Изображение" height="435" image=""></CardMedia>
